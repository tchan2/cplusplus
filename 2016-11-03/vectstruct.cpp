// Tammy Chan
// Write a program that creates a vector of structures, and values of
// the integer and double field should be random values. Sort the
// first vector with respect to n, and sort the second with respect to x.
...
bool cmp1 (const vector_element &a, const vector_element &b);
bool cmp2 (const vector_element &a, const vector_element &b);
